...
_G.packer_plugins = {
  colorschemes = {
    loaded = true,
    path = "/home/rafael/.local/share/nvim/site/pack/packer/start/colorschemes",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/rafael/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  vim = {
    loaded = true,
    path = "/home/rafael/.local/share/nvim/site/pack/packer/start/vim",
